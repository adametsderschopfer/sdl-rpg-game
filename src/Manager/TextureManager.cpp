...
void TextureManager::draw(SDL_Texture *texture, SDL_FRect srcRect, SDL_FRect destRect) {
    SDL_RenderTexture(Game::renderer, texture, &srcRect, &destRect);
}

void TextureManager::draw(SDL_Texture *texture, SDL_FRect srcRect, SDL_FRect destRect, SDL_FlipMode flip) {
